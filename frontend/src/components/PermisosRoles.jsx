...
const VISTAS = [
  ...
  { id:'gobierno',         label:'Gobierno',              desc:'Tablero de reportes y KPIs de gobierno de cuenta (solo admin)', grupo:'Gobierno' },
];
...
const GRUPOS = ['Admin/DPE','Especialista','ITSM','Alertas','Equipo','Gobierno'];
